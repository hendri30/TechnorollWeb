 ...
 *
 * The followings are the available columns in table 'tbl_portfolio':
 * @property integer $id
...
class Portfolio extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, file_name, active, last_update', 'required'),
			...
			array('id, name, file_name, link, active, last_update', 'safe', 'on'=>'search'),
		);
	}
